  ...
  namespace iterator
  {
    ...
    class transform_iterator :
        public std::iterator<
            ...
            typename std::remove_reference<
                typename bliss::functional::function_traits<Transformer,
                    typename std::iterator_traits<Iterator>::value_type>::return_type>::type,
            typename std::iterator_traits<Iterator>::difference_type,
            typename std::add_pointer<
                typename std::remove_reference<
                    typename bliss::functional::function_traits<Transformer,
                        typename std::iterator_traits<Iterator>::value_type>::return_type>::type>::type,
                        ...
                        typename std::iterator_traits<Iterator>::value_type>::return_type>::type>::type>
    {
      ...
      public:
        ...
        transform_iterator(const type& Other)
        ...
        typename std::enable_if<
            ...
            type>::type operator+(difference_type n)
        {
          type output(*this);
        ...
        friend typename std::enable_if<
            std::is_same<iterator_category, std::random_access_iterator_tag>::value,
            type>::type operator+(difference_type n, const type& right)
        {
          return right + n;
        }
        ...
        typename std::enable_if<
            std::is_same<iterator_category, std::random_access_iterator_tag>::value,
            difference_type>::type operator-(const type& other)
        {
        ...
        typename std::enable_if<
            std::is_same<iterator_category, std::random_access_iterator_tag>::value,
            value_type>::type operator[](difference_type n)
        {
          return _f(_base[n]);
        }
