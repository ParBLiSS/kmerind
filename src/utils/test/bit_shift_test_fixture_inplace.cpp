...
template <typename T>
class BitShiftFixedArrayInplaceTest : public ::testing::Test {
  protected:
...
TYPED_TEST_CASE_P(BitShiftFixedArrayInplaceTest);


TYPED_TEST_P(BitShiftFixedArrayInplaceTest, shift_swar_inplace)
{
...
#ifdef __SSSE3__
TYPED_TEST_P(BitShiftFixedArrayInplaceTest, shift_ssse3_inplace)
{
  using data_type = typename ::std::tuple_element<1, TypeParam>::type;
  constexpr size_t data_size = ::std::tuple_element<0, TypeParam>::type::bitsPerGroup;
...
#ifdef __AVX2__
TYPED_TEST_P(BitShiftFixedArrayInplaceTest, shift_avx2_inplace)
{
  using data_type = typename ::std::tuple_element<1, TypeParam>::type;
  constexpr size_t data_size = ::std::tuple_element<0, TypeParam>::type::bitsPerGroup;
...
REGISTER_TYPED_TEST_CASE_P(BitShiftFixedArrayInplaceTest,
#ifdef __SSSE3__
                           shift_ssse3_inplace,
#endif
#ifdef __AVX2__
