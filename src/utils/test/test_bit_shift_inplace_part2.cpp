...
#include "utils/test/bit_shift_test_fixture_inplace.cpp"
...
> BitShiftFixedArrayTestTypes2;
INSTANTIATE_TYPED_TEST_CASE_P(Bliss_2, BitShiftFixedArrayInplaceTest, BitShiftFixedArrayTestTypes2);
