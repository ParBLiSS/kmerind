...
class NoNFASTAParseTest : public KmerReaderTest
{
  // can't compare the sequences directly since offsets may be different.
protected:
...
TEST_P(NoNFASTAParseTest, parse_mmap)
{
#ifdef USE_MPI
    ::mxx::comm comm;
  if (comm.rank() == 0) {
...
TEST_P(NoNFASTAParseTest, parse_stdio)
{
#ifdef USE_MPI
    ::mxx::comm comm;
  if (comm.rank() == 0) {
...
TEST_P(NoNFASTAParseTest, parse_posix)
{
#ifdef USE_MPI
    ::mxx::comm comm;
  if (comm.rank() == 0) {
...
#ifdef USE_MPI
TEST_P(NoNFASTAParseTest, parse_mmap_mpi)
{
    ::mxx::comm comm;
...
TEST_P(NoNFASTAParseTest, parse_stdio_mpi)
{
    ::mxx::comm comm;
...
TEST_P(NoNFASTAParseTest, parse_posix_mpi)
{
    ::mxx::comm comm;
...
TEST_P(NoNFASTAParseTest, parse_mpiio_mpi)
{
    ::mxx::comm comm;
...
INSTANTIATE_TEST_CASE_P(Bliss, NoNFASTAParseTest, ::testing::Values(
    TestFileInfo(243,  434,    13790, std::string("/test/data/natural.fasta")),
    TestFileInfo(245,  490,    14625, std::string("/test/data/natural.withN.fasta")),
    TestFileInfo(6,    246,    940, std::string("/test/data/test2.fasta")),
    TestFileInfo(4,    64,     512, std::string("/test/data/test.fasta")),
    TestFileInfo(4994, 334598, 1092580, std::string("/test/data/test.medium.fasta")),
    TestFileInfo(2,    31155,  31244, std::string("/test/data/test.unitiqs.fasta"))
));
...
class SplitFASTAParseTest : public KmerReaderTest
{
  // can't compare the sequences directly since offsets may be different.
protected:
...
//      using OrigSeqIterType = ::bliss::io::SequencesIterator<BlockIterType, bliss::io::FASTAParser >;
//      using SeqIterType = ::bliss::iterator::filter_iterator<::bliss::io::SequenceNPredicate, OrigSeqIterType>;
    using SeqIterType = ::bliss::io::NSplitSequencesIterator<BlockIterType, bliss::io::FASTAParser >;
...
TEST_P(SplitFASTAParseTest, parse_mmap)
{
#ifdef USE_MPI
    ::mxx::comm comm;
  if (comm.rank() == 0) {
...
TEST_P(SplitFASTAParseTest, parse_stdio)
{
#ifdef USE_MPI
    ::mxx::comm comm;
  if (comm.rank() == 0) {
...
TEST_P(SplitFASTAParseTest, parse_posix)
{
#ifdef USE_MPI
    ::mxx::comm comm;
  if (comm.rank() == 0) {
...
#ifdef USE_MPI
TEST_P(SplitFASTAParseTest, parse_mmap_mpi)
{
    ::mxx::comm comm;
...
TEST_P(SplitFASTAParseTest, parse_stdio_mpi)
{
    ::mxx::comm comm;
...
TEST_P(SplitFASTAParseTest, parse_posix_mpi)
{
    ::mxx::comm comm;
...
TEST_P(SplitFASTAParseTest, parse_mpiio_mpi)
{
    ::mxx::comm comm;
...
INSTANTIATE_TEST_CASE_P(Bliss, SplitFASTAParseTest, ::testing::Values(
    TestFileInfo(243,  434,    13790, std::string("/test/data/natural.fasta")),
    TestFileInfo(256,  490,    14625, std::string("/test/data/natural.withN.fasta")),
    TestFileInfo(6,    246,    940, std::string("/test/data/test2.fasta")),
    TestFileInfo(4,    64,     512, std::string("/test/data/test.fasta")),
    TestFileInfo(5000, 334994, 1092580, std::string("/test/data/test.medium.fasta")),
    TestFileInfo(2,    31155,  31244, std::string("/test/data/test.unitiqs.fasta"))
));
