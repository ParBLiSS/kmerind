...
//    };
    ...
    class fastq_loader : public file_loader<CharType>
    {
      public:
        typedef bliss::io::fastq_parser<CharType*, Alphabet, Quality> ParserType;
        typedef typename ParserType::SeqType                      SequenceType;
        typedef bliss::io::fastq_iterator<ParserType, CharType*>      IteratorType;
        typedef file_loader<CharType>                                   FileLoaderType;
      ...
      protected:
        ...
        RangeType align_to_sequence(
            const std::string &_filename, const RangeType &input,
          ...
          RangeType output(newStart, newEnd, input.overlap);
          return output;
...
//        uint64_t seqIdStart;
        ...
        //      for (int i = max; i > 0; --i)
        //      {
        //        bliss::io::fastq_sequence<char*> result = seqPositions[max - i];
        //
