...
//              INFO("buildIndex rank.tid=" << rank << "." <<  tid << " nReads=" << nReads);
        ...
        void buildForSequence(SeqType &read, IndexType& index) {
          ...
          KmerIndexIterType index_end = end;
  ...
  //          KmerType idx;
    ...
    class KmerPositionAndQualityIndexOld {
      protected:
        ...
        /// DEFINE the iterator parser to get fastq records.  this type determines both the file format and whether quality scoring is used or not.
        using ParserType = bliss::io::FASTQParser<FileBlockIterType, float>;
        ...
        using QualityType = typename QualIterType::QualityType;

        using KmerInfoIterType = bliss::iterator::ZipIterator<IdIterType, QualIterType>;
        using KmerInfoType = typename KmerInfoIterType::value_type;
        ...
        /// define the index storage type.  using an infix of kmer since prefix is used for distributing to processors.
        typedef bliss::index::distributed_multimap<KmerType,
                                                   typename KmerInfoIterType::value_type,
                                                   bliss::io::CommunicationLayer<ThreadLocal>,
                                                   bliss::KmerSuffixHasher<KmerType>,
                                                   bliss::KmerPrefixHasher<KmerType> > IndexType;
