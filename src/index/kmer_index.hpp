      ...
      public:
        ...
        KmerIndex(MPI_Comm _comm, int _comm_size,
          ...
          index(_comm, _comm_size, num_threads, 
                bliss::hash::murmur::KmerInfixHash<KmerType>(ceilLog2(num_threads), ceilLog2(_comm_size)),
                bliss::hash::murmur::KmerPrefixHash<KmerType>(ceilLog2(_comm_size))
          ),
...
#pragma omp parallel num_threads(nthreads) shared(loader, nthreads, index, rank) OMP_SHARE_DEFAULT
    ...
    class KmerCountIndex : public KmerIndex<bliss::index::distributed_counting_map<bliss::common::Kmer<Kmer_Size, Alphabet>,
    bliss::io::CommunicationLayer<ThreadLocal>,
    bliss::hash::murmur::KmerSuffixHash<bliss::common::Kmer<Kmer_Size, Alphabet> >,
    bliss::hash::murmur::KmerInfixHash<bliss::common::Kmer<Kmer_Size, Alphabet> >,
    bliss::hash::murmur::KmerPrefixHash<bliss::common::Kmer<Kmer_Size, Alphabet> > >,
    FileFormat, void, ThreadLocal>
    {
      public:
        ...
        using MapType = bliss::index::distributed_counting_map<KmerType,
            bliss::io::CommunicationLayer<ThreadLocal>,
            bliss::hash::murmur::KmerSuffixHash<KmerType>,
            bliss::hash::murmur::KmerInfixHash<KmerType>,
            bliss::hash::murmur::KmerPrefixHash<KmerType> >;
