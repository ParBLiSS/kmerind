...
#include "common/test/kmer_reverse_op_test_fixture.cpp"
...
> KmerReverseOpTestDNA16Types;
INSTANTIATE_TYPED_TEST_CASE_P(Bliss_DNA16, KmerReverseOpTest, KmerReverseOpTestDNA16Types);
