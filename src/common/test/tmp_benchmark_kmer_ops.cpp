...
// split up the types into groups, and give each one a different group name (i.e. Bliss_Kmer_WordType, Bliss_Kmer_FullWords, etc)

// max of 50 cases per test.
...
> KmerOpsBenchmarkWordTypes;
INSTANTIATE_TYPED_TEST_CASE_P(Bliss_Kmer_WordTypes, KmerOpsBenchmark, KmerOpsBenchmarkWordTypes);
...
> KmerOpsBenchmarkPartWordsTypes;
INSTANTIATE_TYPED_TEST_CASE_P(Bliss_Kmer_PartWords, KmerOpsBenchmark, KmerOpsBenchmarkPartWordsTypes);
...
> KmerOpsBenchmarkFullWordsTypes;
INSTANTIATE_TYPED_TEST_CASE_P(Bliss_Kmer_FullWords, KmerOpsBenchmark, KmerOpsBenchmarkFullWordsTypes);
